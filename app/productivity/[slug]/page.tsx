...
export default async function ProductivityPostPage({
    ...
    const post = prodPosts.find((post) => post.slug === slug);
  ...
  return (
    <main className='min-h-screen bg-gray-100 p-8'>
      <div className="max-w-4xl mx-auto mx-auto flex max-w-7xl flex-col items-start gap-4 p-4 mt-10">
        <Link href="/productivity" className="text-blue-600 hover:underline">
            &larr; Back to Productivity Articles
        </Link>
